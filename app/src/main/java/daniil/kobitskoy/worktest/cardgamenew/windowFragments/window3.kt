...
import daniil.kobitskoy.worktest.cardgamenew.databinding.Window3Binding

class window3 : Fragment() {

    private var binding: Window3Binding? = null
    ...
    override fun onCreateView(
        ...
        binding = Window3Binding.inflate(inflater,container,false)
