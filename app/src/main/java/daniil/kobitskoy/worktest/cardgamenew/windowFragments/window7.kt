...
import daniil.kobitskoy.worktest.cardgamenew.databinding.Window7Binding


class window7 : Fragment() {


    private var binding: Window7Binding? = null
    ...
    override fun onCreateView(
        ...
        binding = Window7Binding.inflate(inflater,container,false)
