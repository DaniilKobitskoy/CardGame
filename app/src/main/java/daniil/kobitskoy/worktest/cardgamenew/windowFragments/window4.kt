...
import daniil.kobitskoy.worktest.cardgamenew.databinding.Window4Binding


class window4 : Fragment() {

    private var binding: Window4Binding? = null
    ...
    override fun onCreateView(
        ...
        binding = Window4Binding.inflate(inflater,container,false)
